        ...
        <div className='features'>
            <div className='features__item'>
                <div className='features__wrapper'>
                    ...
                    <Link className='features__link' to = '/catalog'>Каталог SLIM <span className='features__link-icon'></span></Link>
                </div>
                ...
                <div className='features__item'>
                    <div className='features__wrapper'>
                        ...
                        <Link className='features__link' to = '/catalog'>Каталог PRO <span className='features__link-icon'></span></Link>
                    </div>
